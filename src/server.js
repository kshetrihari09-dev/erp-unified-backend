...
const purchaseSuggestionsRouter = require('./routes/purchaseSuggestions')
...
const customerProductsRouter = require('./routes/customerProducts')
...
app.use(`${API}/purchase-suggestions`,  purchaseSuggestionsRouter)
